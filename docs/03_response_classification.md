...
## What It Does
- **Language Detection**: Identifies English, Persian, Mixed, and English-with-Persian-tokens using Unicode character ratio analysis on the Persian character set (U+0600–U+06FF)
...
- **Response Type Classification**: Categorizes into 6 types:
  ...
  - `conversational_advice`: Question-asking, engaging style
...
- Language distribution: 85.9% English, 10.4% Persian, 3.7% Mixed
- LM instances: Claude 6 (accurate), Gemini 8 (CME errors), ChatGPT 0
- Refusal rate: 13.3% overall (mostly false positives on short Claude responses)
